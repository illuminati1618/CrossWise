...
<div class="max-w-7xl mx-auto px-4 py-24">
    ...
    <div class="space-y-24">
        ...
        <section class="opacity-0 transform translate-y-10 transition-all duration-[1.5s]" data-scroll>
            <details open>
                <summary class="text-2xl font-semibold text-gray-200 mb-6 cursor-pointer">Current Border Wait Times</summary>
                <div class="mt-6">
        ...
        <section class="opacity-0 transform translate-y-10 transition-all duration-[1.5s]" data-scroll>
            <details open>
                <summary class="text-2xl font-semibold text-gray-200 mb-6 cursor-pointer">Wait Time Trends</summary>
                <div class="mt-6">
        ...
        <section class="opacity-0 transform translate-y-10 transition-all duration-[1.5s]" data-scroll>
            <details open>
                <summary class="text-2xl font-semibold text-gray-200 mb-6 cursor-pointer">Key Features</summary>
                <div class="mt-6">
                    <div class="grid grid-cols-2 gap-6">
                        <div class="bg-dark p-6 rounded-lg shadow-md">
